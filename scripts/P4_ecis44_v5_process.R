...
varbin_mtx_all4@colData 

#---t5--
varbin_mtx5 <- readVarbin(raw_path5, remove_Y = TRUE)
varbin_mtx5 
varbin_mtx_all5 <- varbin_mtx5
varbin_mtx_all5@colData 
...
gene_bin_sel <- gene_bin %>% dplyr::filter(gene %in% c("AKT3","PPP2R2A","CCNE2","MYC","CDKN2A","BRCA2","RB1","WWOX","TP53","BRCA1"))
...
chip_dna_path1 <- c("data/waferDR_ECIS44_chip1_DNA/waferDR_ECIS44_chip2-DNA_200/res_200_k")
chip_dna_path2 <- c("data/waferDR_ECIS44T_Tube2_Chip1_DNA/waferDR_ECIS44T_Tube2_Chip1-DNA_200/res_200_k")
chip_dna_path3 <- c("data/waferDR_ECIS44_chip2_DNA/waferDR_ECIS44_chip2-DNA_200/res_200_k")
chip_dna_path4 <- c("data/waferDR_ECIS44_tube4_chip1_DNA/waferDR_ECIS44_tube4_chip1-DNA_200/res_200_k")
chip_dna_path5 <- c("data/waferDR_ECIS44T_tube3_chip2_DNA/waferDR_ECIS44T_Tube3_Chip2-DNA_200/res_200_k")
...
Heatmap(as.matrix(cs_mtx_order), cluster_columns = FALSE, border = TRUE, cluster_rows = FALSE, show_row_dend = FALSE, 
        ...
        use_raster = T, raster_quality = 5, col = col_vec, 
        heatmap_legend_param = list(title = "copy number", title_gp = gpar(fontsize = 12, fontface = "bold"), labels_gp = gpar(fontsize = 12)), 
        top_annotation = ha_col, left_annotation = ha_row_cs,right_annotation = ha_barplot,bottom_annotation = ha_bottom_cs)
dev.off()
